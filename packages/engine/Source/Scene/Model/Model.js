...
function getUpdateHeightCallback(model, ellipsoid, originalPostition) {
  return function (clampedPosition) {
    if (model.heightReference === HeightReference.CLIP_TO_GROUND) {
      if (originalPostition.height >= clampedPosition.height) {
        clampedPosition.height = originalPostition.height;
      }
    } else if (isHeightReferenceRelative(model.heightReference)) {
      clampedPosition.height += originalPostition.height;
    }
